...
mkdir /home/nfs/
mkdir /media/CentOS/
mount -t nfs 9.186.105.78:/home/nfs/ /home/nfs/
...
ifconfig eth0 0.0.0.0 #(eth1 is the NETWORK_DEVICE in build.include)
...
sed -i 's/NETWORK_DEVICE= /NETWORK_DEVICE=eth0/g' ./build.include
