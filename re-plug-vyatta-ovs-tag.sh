PORT_IP1="192.168.100.3"
PORT_IP2="9.186.105.240"
NET_NAME1="internal"
NET_NAME2="external"

TAP_ID1=`neutron port-list | grep ${PORT_IP1} | awk '{print $2}' | cut -c 1-11`
#echo TAP_ID1=${TAP_ID1}
TAP_NAME1=tap${TAP_ID1}
echo INT_TAP_NAME=${TAP_NAME1}

TAP_ID2=`neutron port-list | grep ${PORT_IP2} | awk '{print $2}' | cut -c 1-11`
